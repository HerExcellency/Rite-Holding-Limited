                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-lg-2 col-sm-5  offset-xl-1 offset-sm-1 offset-lg-0 order-sm-4 order-lg-0 xs-margin-25px-bottom">
                            ...
                            <ul>                           
                                ...
                                <li><a href="//www.instagram.com/riteapartments/" target="_blank">Real Estate</a></li>
                                <li><a href="//pastarepublic.ng/" target="_blank">Food</a></li>
                            </ul>
                        </div>
                        <!-- end footer column -->                    
                        <!-- start footer column -->
                ...
                <div class="container"> 
                    <div class="row align-items-center">
                        <div class="col-12 col-md-3 text-center text-md-start sm-margin-20px-bottom">
                            <a href="<?php echo base_url(); ?>" class="footer-logo"><img src="assets/img/riteHoldingsWhite.png" data-at2x="img/riteHoldingsWhite.png" alt=""></a>
                        </div>
                        <div class="col-12 col-md-6 text-center last-paragraph-no-margin sm-margin-20px-bottom">
                            <p>Copyrights &copy; 2022 All Rights Reserved by Rite Holdings Limited  </p>
                        </div>
                        <div class="col-12 col-md-3 text-center text-md-end">
                            <div class="social-icon-style-12">
                                <ul class="extra-small-icon light">
                                    <li><a class="facebook" href="//twitter.com/riteholdings?s=11" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                    <li><a class="dribbble" href="//www.linkedin.com/company/rite-holdings/" target="_blank"><i class="fab fa-linkedin"></i></a></li>
                                    <li><a class="instagram" href="//www.instagram.com/riteholdings/" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
